...
public class ResponseParser {
    ...
    private ResponseParser(int code, String message) {
        this.code = code;
    ...
    public static ResponseParser parse(BufferedReader reader) throws IOException {
        ...
        return new ResponseParser(code, message.toString());
    }
